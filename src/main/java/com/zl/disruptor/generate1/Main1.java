...
public class Main1 {  
	...
	public static void main(String[] args) throws Exception {  
        ...
        //创建SequenceBarrier （直译就是sequence的障碍，用来平衡生产者和消费者的速度）
        ...
        //这一步的目的就是把消费者的位置信息引用注入到生产者（也就是告诉生产者消费端消费的进度，生产者就可以继续生产了）
        // 如果只有一个消费者的情况可以省略
        ...
        future.get();//等待生产者结束 ，等待十个for循环结束
